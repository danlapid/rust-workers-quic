...
| --- | --- | --- | --- | --- |
| emscripten frontend | `guybedford/emscripten` branch `cf` | `21166256c4c4d73d39b3685c8973d7cbe427ce8c` (`6.0.7-git`) | Direct clone to `.work/emscripten` | Integrated epoll, async DNS, UDP/TCP over `-sNODERAWSOCKETS`, wasm-bindgen, blocking socket operations, and upstream `recvmmsg` support. |
...
| libc | `guybedford/libc@libc-0.2-emscripten` | `4091fe0b0dc5f9c1a27bed75be1ff02bb27e756d` | None. Includes epoll and `in6_pktinfo`. |
...
| quanta | `metrics-rs/quanta@main` | `bb6ca3f82b0b0cfbd7c04a0221f82e63d06a47ed` | None. Upstream selects the POSIX monotonic clock on Emscripten. |
...
| --- | --- | --- | --- |
| mio | `guybedford/mio@emscripten` | `a62c9e46833fc255c9217ab9aa362c6221ed4401` | Emscripten epoll backend used by Tokio's standard TCP and UDP types. |
...
| `quinn-udp` | `0.5.15` | Stock Unix backend, including its batched `recvmmsg` receive path. |
